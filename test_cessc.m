function [cesscn_lable,cesscnmatrix]=test_cessc(x,miu,nlei,gammajj,gammajk)
% clear all
% clc
% load x.csv
...
fenzi(j,i)=exp(b1(j,i)*miu(j,i)+a2(j,i))/(gammajj*miu(j,i));
    end
end
for dede=1:1:row
    fenmu(dede,:)=sum(fenzi(dede,:));
